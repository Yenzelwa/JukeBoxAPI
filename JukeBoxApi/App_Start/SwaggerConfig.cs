        ...
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                .EnableSwagger(c =>
                {
                    ...
                    c.RootUrl(ComputeHostAsSeenByOriginalClient);
                    c.RootUrl(SwaggerDocsConfig.DefaultRootUrlResolver);
                    ...
                    //
                    c.SingleApiVersion("v1", "BET Internal Web Services");
                ...
                .EnableSwaggerUi(c =>
                {
                    c.InjectStylesheet(Assembly.GetAssembly(typeof(WebApiApplication)), "BETInternalWebServices.Content.myStyle.css");
